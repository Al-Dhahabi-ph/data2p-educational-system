...
export default function EditCourseDialog({ open, onOpenChange, course, onSubmit }: EditCourseDialogProps) {
  ...
  useEffect(() => {
    if (course) {
      setFormData({
        ...
        hasPracticals: course.hasPracticals || false,
        theoryProfessors: course.theoryProfessors?.length ? course.theoryProfessors : [''],
        practicalProfessors: course.practicalProfessors?.length ? course.practicalProfessors : [''],
      });
    }
  }, [course]);
