...
export class Client {
    ...
    public readonly lectures: lectures.ServiceClient
    ...
    constructor(target: BaseURL, options?: ClientOptions) {
        ...
        this.lectures = new lectures.ServiceClient(base)
 ...
 * Import the endpoint handlers to derive the types for the client.
 */
import { get as api_lectures_get_get } from "~backend/lectures/get";
import { list as api_lectures_list_list } from "~backend/lectures/list";
...
export namespace lectures {
    ...
    export class ServiceClient {
         ...
         */
        public async get(params: { id: string }): Promise<ResponseType<typeof api_lectures_get_get>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/lectures/${encodeURIComponent(params.id)}`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_lectures_get_get>
        }

        /**
         * Retrieves lectures for a specific course.
         */
        public async list(params: RequestType<typeof api_lectures_list_list>): Promise<ResponseType<typeof api_lectures_list_list>> {
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/lectures`, {query, method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_lectures_list_list>
        }
    }
}
