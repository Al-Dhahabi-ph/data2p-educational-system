...
```bash
git remote add encore encore://data2p-educational-system-bxri
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/data2p-educational-system-bxri/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/data2p-educational-system-bxri/settings/integrations/github)
